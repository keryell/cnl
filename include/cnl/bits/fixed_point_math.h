...
namespace cnl {
    ...
    namespace _impl {
        namespace fp {
            ...
            template<class Rep, int Exponent, _impl::enable_if_t<greater_than_or_equal_tag(Exponent, 0), int> dummy = 0>
            ...
            template<class Rep, int Exponent, _impl::enable_if_t<less_than_tag(Exponent, 0), int> dummy = 0>
